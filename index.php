        ...
        <main>
          <div class="logo">
            <img src="asset/img/logo.svg" alt="">
               ...
               <div class="form2"></div>
           <div class="para">
              <h2><span class="salut">Salut__!</span>
          ...
          <div id="projet-menu">
               <h2 class="titre-projet">[Pro-jects]<span class="petit-numero1">(001)<span></h2>
               
               <div class="trait-horizontal2"></div>
          </div>
         
          <div id="about-menu">
          <div class="form3"></div>
               <div class="form4"></div>
               <h2 class="titre-about">[Ab-out]<span class="petit-numero2">(002)<span></h2>
                    <p class="mini_para1">
          ...
          <?php require "asset/inc/contact.php"; ?>
     </main >
