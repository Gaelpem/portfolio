...
<h1 class="titre-portfolio">PORTFOLIO<span class="copyright">&copy;</span></h1>
   <section> 
    ...
    <div class="trait-horizontal3"></div>
...
<section id="projet-menu" >
  
<div class="projet-container">
    <h1>[Proje-ts]<span class="number01">(01)</span></h1>
...
<section id="projet-about">
<div class="trait-horizontal5"></div>
 
<h1 class="titre-about">[À-propos]<span class="number02">(02)</span></h1>  
    <article class="grid ">
...
<section class="menu">
<h1 class="menu-titre">[Men-u]<span class="number04">(04)</span></h1> 
...
<?php require "asset/inc/footer.inc.php"; ?>
</main>